/**
 * Local mock GraphQL server seed.
 *
 * Run with:  npm run mock:server
 *   (equivalent to: npx json-graphql-server db.js --port 4000)
 *
 * Exposes a GraphQL endpoint at http://localhost:4000/graphql exposing
 * `trainers` and `teams` types with auto-generated queries + mutations.
 */
module.exports = {
  trainers: [
    {
